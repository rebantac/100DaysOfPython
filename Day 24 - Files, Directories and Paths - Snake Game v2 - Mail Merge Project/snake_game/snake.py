...
class Snake:
    ...
    def reset_snake(self):  # when the user loses, a new snake is initialized
        # to make the previous snake disapper, we set its position off the screens
        for segment in self.segments:
            segment.setpos(1000, 1000) # location is out of the 300x300 screen
